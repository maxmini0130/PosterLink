...
export async function classifyPosterImage(imageUrl, context = {}) {
  ...
  try {
    ...
    const prompt = [
      ...
      "Return isPoster=false for scanned official administrative documents, two-column/public-notice document scans, gazette-style announcements, or plain recruitment notice documents even when the document image contains title, dates, seal, contact, and application details.",
